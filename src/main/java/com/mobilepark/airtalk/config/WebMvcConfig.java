package com.mobilepark.airtalk.config;

import com.mobilepark.airtalk.interceptor.AuthenticationInterceptor;
// import com.mobilepark.airtalk.interceptor.HistoryInterceptor;
// import com.mobilepark.airtalk.service.HistoryService;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    // @Autowired
    // public WebMvcConfig(Environment env, HistoryService historyService) {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        //         .excludePathPatterns("/admin/menu/adminAuthMenu.json")  //좌측리 메뉴 조회 예외 처리
        //         .excludePathPatterns("/admin/menu/getRoot.json")        //메뉴 관리에서 조회 예외 처리
        //         .excludePathPatterns(ADMIN_LOGIN)                    //로그인 페이지 예외 처리
