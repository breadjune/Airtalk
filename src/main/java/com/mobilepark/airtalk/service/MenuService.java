...
public class MenuService {
    ...
    public List<Map<String, Object>> getRoot() {
        ...
        try {
            List<Menu> selectMenuList = menuRepository.findAll(Sort.by(Sort.Direction.ASC, "sort"));
    ...
    public List<Menu> getMenuList() {
        try {
            ...
            List<Menu> menuList = menuRepository.findByParentSeqNot(0, Sort.by(Sort.Direction.ASC, "sort"));
    ...
    public List<Map<String, Object>> adminAuthMenu(Integer adminGroupSeq) {
        ...
        try {
            List<AdminGroupAuth> adminGroupAuthList = adminGroupAuthRepository.findByAdminGroupSeq(adminGroupSeq, Sort.by(Sort.Direction.ASC, "menu.sort"));
...
*/
    ...
    public List<MenuFunc> menuFuncSearch(int menuSeq) {
        List<MenuFunc> menuFuncList = new ArrayList<>();
        try {
            menuFuncList = menuFuncRepository.findByMenuSeq(menuSeq, Sort.by(Sort.Direction.DESC, "regDate"));
        } catch(Exception e) {
            logger.error(e.getMessage());
        }
